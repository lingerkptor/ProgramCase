...
public class QuartzConfiguration {
    ...
    @Bean
    public QuartzInitializerListener executorListener(@Autowired SchedulerFactoryBean schedulerFactoryBean) {
    ...
    public SchedulerFactoryBean schedulerFactoryBean(@Autowired JobFactory jobFactory,
                                                     @Autowired @Qualifier("quartzProp") Properties quartzProperties) {
